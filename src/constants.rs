/*
    this file contains constants that are used in aes such as the rijndael S-Box, its inverse
    and substitution boxes for commonly used Galois multiplication constants such as multiplication 
...
pub const S_BOX:[u8;256] =[
    //   00    01    02    03    04    05    06    07    08    09    0a    0b    0c    0d    0e    0f      
        ...
        0xba, 0x78, 0x25, 0x2e, 0x1c, 0xa6, 0xb4, 0xc6, 0xe8, 0xdd, 0x74, 0x1f, 0x4b, 0xbd, 0x8b, 0x8a, //0c
...
pub const G_MUL_9_TABLE:[u8;256] =[
...
pub const G_MUL_11_TABLE:[u8;256] = [
...
pub const G_MUL_13_TABLE:[u8;256] =[
...
pub const G_MUL_14_TABLE:[u8;256]=[
...
pub const MIX_COL_MATRIX:[u8;16]=[
    02,03,01,01,
    01,02,03,01,
    01,01,02,03,
    03,01,01,02
...
pub const INV_MIX_COL_MATRIX:[u8;16]=[
    14,11,13,9,
    9,14,11,13,
    13,9,14,11,
    11,13,9,14
